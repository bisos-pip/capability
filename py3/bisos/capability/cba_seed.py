...
####+BEGIN: b:py3:class/decl :className "CbaSeedInfo" :superClass "object" :comment "Abstraction of the seed Interface" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /CbaSeedInfo/  superClass=object =Abstraction of the seed Interface=  [[elisp:(org-cycle)][| ]]
#+end_org """
class CbaSeedInfo(object):
####+END:
    """
** Abstraction of
"""
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance = super(CbaSeedInfo, cls).__new__(cls)
    ...
    @loader.setter
    def loader(self, value: str | None,):
        self._loader = value
    ...
    @assemble.setter
    def assemble(self, value: str | None,):
        self._assemble = value
