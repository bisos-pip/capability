...
####+END
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :title "Overview and Use Cases" :anchor "Panel" :extraInfo "  /::Cap Bundle {Abstraction, Specification, Materialization}::/"
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Overview and Use Cases:* |]] <<Panel>>   /::Cap Bundle {Abstraction, Specification, Materialization}::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** Capability Bundles -- Abstraction (cba) -- Specification (cbs) and Materialization (cbm)
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Platform Reconstruction, PALS and PAAI" :anchor "" :extraInfo "  /::::/"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Platform Reconstruction, PALS and PAAI:* |]]    /::::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Capability Bundle Abstraction (cba)" :anchor "" :extraInfo "  /::The Seed::/"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Capability Bundle Abstraction (cba):* |]]    /::The Seed::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** For example in facter cbs, cba-sysd.cs, cba_sysd_seed, cba_seed
** cba_seed is part of  bisos.capability
** Other cba seeds (eg cba-sysd.cs) can be part of other packages
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep nil :title "Capability Bundle Specification (cbs)" :anchor "" :extraInfo "  /::Planted::/"
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Capability Bundle Specification (cbs):* |]]    /::Planted::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** For example in facter: [[file:/bisos/git/auth/bxRepos/bisos-pip/facter/py3/bin/facter-cbs-is-np-sysd.cs]]
** --- Summary Begin
...
** --- Summary End
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep nil :title "Capability Bundle Materialization (cbm)" :anchor "" :extraInfo "  /::List of CBS to be Materialized::/"
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Capability Bundle Materialization (cbm):* |]]    /::List of CBS to be Materialized::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** List of CBS-es operated on with bisos.capability
** These are typically in  [[file:/bisos/platform/sys/cbm/]]
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Self Contained Services (scs)" :anchor "" :extraInfo "  /::BXO with cbs-es and Data::/"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Self Contained Services (scs):* |]]    /::BXO with cbs-es and Data::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** When the CBS needs to have its own data, eg DHCP Capability or DNS Capability, then
** Data and Capability Specification are packaged in a BXO.
** Example: pmz_dhcpStatic-privA
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep nil :title "ByStar Service Instace (si)" :anchor "" :extraInfo "  /::BXO with cbs-es for Virtualized Domains::/"
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *ByStar Service Instace (si):* |]]    /::BXO with cbs-es for Virtualized Domains::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** Similar to SCS, plus ByStar Domain Virtualization
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep nil :title "Possesion Assertable Libre Services (PALS&PAAI)" :anchor "" :extraInfo "  /::BXO: -> to CBS, SCS and SI-s::/"
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Possesion Assertable Libre Services (PALS&PAAI):* |]]    /BXO: -> to CBS, SCS and SI-s/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** A set of related capabilities that can be materialized
** PALS also include Possesion Assertable Autonomous Identity (PAAI)
** PAAI-Framework + domainName + registrations + PALSs
** When PALS are of ByStar Service (eg ByName), it is called (Portable ByStar Service) PBS-BPO
** -B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep nil :title "Platform PALS" :anchor "" :extraInfo "  /::List of PALS of a Platform::/"
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Platform PALS:* |]]    /::List of PALS of a Platform::/  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** Typically in [[file:/bisos/platform/palsList]]
** -B|
...
** -B|
* +
* SEE [[file:/bisos/panels/bisos-core/capability/_nodeBase_/fullUsagePanel-en.org]]
* ------------------
...
*  3.1 _dvwis_ == Domain Virtualizer Web Independent Service (NGINX)
*  3.2 _dvmis_ == Domain Virualizer Mail Independent Service (QMAIL)
...
* ---
* Capability Materialization is done with the bisos.capMater package. (NOTYET, is that in bisos.capability)
*  /capMater Specification Files/ (Capability Bundle Materialization Specification File)  resides in the
* sys/cbm repo of BPO-Platform. The ~bpo/sys/cap/cbMaterManage.cs (similar to ~bpo/sys/bin/cntnrAssemble.sh).
* ---
* Naming convention for /Capability Bundle Specification files/ (cbs) is as follows:
*     {cbName}-cbs-{[[MaterializedCapabilityForm]]}-{[[CapabilityType]]}-{[[CapabilityParticular]]}.cs
* Example: facter-cbs-is-np-sysd.cs
* Old Example   cbMater-is-o-geneweb-simpsonFamily-niche.cs
* ---
* Materialization (execution) of cbs files results in:
